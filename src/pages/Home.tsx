  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
              {categories.map((category) => (
                <Link
                  ...
                  className="group relative overflow-hidden rounded-2xl shadow-card hover:shadow-premium hover-lift transition-all duration-300"
                >
      ...
      <ProductSection
        ...
        badge={{ text: "NOVO", color: "bg-accent text-accent-foreground" }}
      />
      ...
      <ProductSection 
        ...
        badge={{ text: "OFERTA", color: "bg-destructive text-destructive-foreground" }}
      />
