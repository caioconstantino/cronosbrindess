...
import { LayoutDashboard, Package, Layers, ShoppingCart, Users, Settings, Image, Building2, UserCog } from "lucide-react";
...
const settingsNavigation = [
  { name: "Banners", href: "/admin/configuracoes/banners", icon: Image },
  { name: "Clientes", href: "/admin/configuracoes/clientes", icon: Building2 },
];
